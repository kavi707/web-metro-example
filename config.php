...
$siteTitle = 'Test Metro'; /* will be displayed above the url-bar */
$siteName = 'Test Metro'; /* The biggest title on your homepage */
$siteDesc ='Localize Sinhala tutorials for codings'; /*subtitle */
